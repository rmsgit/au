<div class="row">
    ...
    <form method="post" role="form">
        ...
        <div>
            ...
            <div class="col-lg-2" style="padding-right: 0;padding-left: 0;">
                <input type="button" class="btn btn-primary" align="center" style="width: 100%" value="Register" onclick="open_root('student_register')">
            </div>
            <div class="col-lg-1"></div>
            <div class="col-lg-2" style="padding-right: 0;padding-left: 0;">
